...
Skill Matchmaking → Players matched by rank & experience.

Join/Create Game Room → Entry points deducted and quiz started.

Real-Time Quiz Battle → Socket.io enables instant Q&A sync.

Winner Rewarded → Points credited and leaderboard updated.
